...
(function () {
    ...
    contextPrototype.fillText = function(text, x, y, maxWidth, fontSize, fontSizeMultiplier) {
        ...
        this.currentFont.processText(p, text, maxWidth, color, fontSize, this.canvas, this.m_, fontSizeMultiplier);
    };

    contextPrototype.strokeText = function(text, x, y, maxWidth, fontSizeMultiplier) {
