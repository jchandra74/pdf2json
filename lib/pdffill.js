...
var PDFFill = (function PFPLineClosure() {
    ...
    cls.prototype.processFill = function (targetData) {
        ...
        var oneFill = {x:this.x,        //PDFUnit.toFormX(this.x),
                       y:this.y,        //PDFUnit.toFormY(this.y),
                       w:this.width,    //PDFUnit.toFormX(this.width),
                       h:this.height,   //PDFUnit.toFormY(this.height),
                       c: this.color};  //clrId};
